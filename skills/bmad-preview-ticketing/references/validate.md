...
- Merge findings into fix (mechanical), suggest (a guideline, with its reason), or ask (needs the user). Resolve coverage gaps, missing blockers, and contradictions before proceeding; the user decides suggestions and scope changes.
