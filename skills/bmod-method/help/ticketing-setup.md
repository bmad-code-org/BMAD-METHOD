...
- The build writes its plan, `<type>-<slug>-plan.md`, beside `tickets.toml`. The plan carries the ticket's `status`, which the build moves as far as `in-review`. After reviewing the work, the user says "mark story 1.2 done".
