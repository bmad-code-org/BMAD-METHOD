...
4. Tell the user it is ready: local paths and external destinations (URLs returned from handoffs). Invoke `bmad` to suggest what next steps make sense in the bmad method ecosystem.
