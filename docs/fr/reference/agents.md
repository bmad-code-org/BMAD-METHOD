...
| Développeur (Amelia)        | `bmad-agent-dev`         | `DS`, `QD`, `QA`, `CR`, `SP`, `CS`, `DD`, `ER` | Dev Story, Quick Dev, Génération de Tests QA, Code Review, Sprint Planning, Créer Story, Detail Design, Rétrospective d’Epic |
