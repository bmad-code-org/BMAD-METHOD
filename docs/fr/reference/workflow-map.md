...
| `bmad-deep-recon` | Validez vos hypothèses ou choisissez entre des options — recherche marché, domaine, technique, concurrentielle, voix des utilisateurs, académique ; vérifiée, citée, actualisable | Rapport de recherche + briefing HTML optionnel |
