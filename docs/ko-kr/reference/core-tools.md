...
**출력:** 세션 보관용 독립 `brainstorm.html`, 후속 스킬용 선택적 `brainstorm-intent.md`, 그리고 `.memlog.md` 세션 기록
...
- `input`(필수) - 경로 또는 인라인 텍스트. 모호한 아이디어, 브레인 덤프, PRD, GDD, RFC, 제품 브리프, 대화록, 목업 폴더, 여러 소스 조합.
...
1. 5개 구조 모델(튜토리얼, 참조, 설명, 프롬프트, 전략)로 문서를 분석합니다
