...
적대적 리뷰와는 의도적으로 반대되는 방식입니다. 적대적 리뷰에서는 리뷰어가 문제를 찾고 사용자는 거짓 양성을 걸러냅니다. 여기서는 질문자가 근거 없이 동의하지 않습니다. 긴장감이 유지되므로 사용자는 그 압력 아래에서 더 깊게 생각합니다. 편안한 대화보다 더 나은 아이디어를 남기는 데 초점을 둡니다.
