...
`code` 명령을 사용할 수 있으면 Build가 프로젝트와 완성된 사양을 VS Code에서 엽니다. Suggested Review Order의 링크를 따라 변경 사항을 살펴볼 수 있습니다.
...
이제 복잡한 오픈 소스 코드베이스에 유용한 기능을 추가했습니다. VS Code를 사용한다면 그곳에서 완성된 변경 사항을 보고 있을 것입니다.
