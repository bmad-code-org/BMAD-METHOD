...
| `bmad-deep-recon` | Validace předpokladů nebo výběr mezi variantami — tržní, doménový, technický, konkurenční, uživatelský a akademický výzkum; ověřené, citované, obnovitelné | Výzkumná zpráva + volitelný HTML briefing |
