...
- **průzkum** (`bmad-deep-recon`) — Tržní, doménový, technický, konkurenční, uživatelský a akademický průzkum — plus režim výběru mezi variantami — s ověřováním tvrzení a životním cyklem obnovy
