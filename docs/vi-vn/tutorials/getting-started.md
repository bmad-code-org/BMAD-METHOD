...
- **research** (`bmad-deep-recon`) — Nghiên cứu thị trường, miền nghiệp vụ, kỹ thuật, cạnh tranh, tiếng nói người dùng và học thuật — kèm chế độ lựa chọn giữa các phương án — với kiểm chứng luận điểm và vòng đời làm mới
