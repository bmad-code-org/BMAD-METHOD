...
| `bmad-ticket` | Phân rã yêu cầu thành các phần việc có thể triển khai | Cây ticket gồm các thư mục epic và file story |
...
`bmad-create-epics-and-stories` được giữ lại dưới dạng shim tương thích v6, chuyển tiếp sang `bmad-ticket`.
