...
| `bmad-spec`                     | Condense input into a short spec; hand story breakdown to `bmad-preview-ticketing`                | [Define Requirements and a Specification](../plan/define-requirements-and-a-specification.md)          |
...
| `bmad-preview-ticketing` | Plan and track initiatives, epics, and entries | [Break Work into Stories and Track It](../plan/break-work-into-stories-and-track-it.md) |
