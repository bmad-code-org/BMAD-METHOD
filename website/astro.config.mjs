...
export default defineConfig({
  ...
  redirects: {
    ...
    '/explanation/checkpoint-preview': `${basePath}build/review-a-completed-change/`,
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Review a Completed Change',
              translations: {
                'vi-VN': 'Xem lại thay đổi đã hoàn thành',
                'zh-CN': '审查已完成的变更',
                'fr-FR': 'Examiner un changement terminé',
                'cs-CZ': 'Zkontrolovat dokončenou změnu',
              },
              slug: 'build/review-a-completed-change',
            },
          ],
        },
        {
