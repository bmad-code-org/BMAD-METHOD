...
test('spec template exposes machine-readable deferred frontmatter', () => {
  const relativePath = 'src/bmm-skills/shipping/bmad-build-auto/spec-template.md';
...
test('build-auto steps preserve their frontmatter boundaries', () => {
  const root = 'src/bmm-skills/shipping/bmad-build-auto';
...
test('review step safely records deferred findings only in the spec', () => {
  const content = read('src/bmm-skills/shipping/bmad-build-auto/step-04-review.md');
