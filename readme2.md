...
We're actively developing new capabilities. Here's what's on the roadmap:

| Feature                     | Status      | Expected    |
| --------------------------- | ----------- | ----------- |
| **Feature Name One**        | In Progress | Q1 2026     |
| **Feature Name Two**        | Planned     | Q2 2026     |
| **Feature Name Three**      | Planned     | Q2 2026     |
| **Feature Name Four**       | Exploring   | TBD         |

- **Feature Name One** — Lorem ipsum dolor sit amet, consectetur adipiscing elit. Brief description of what this feature will enable.
- **Feature Name Two** — Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
- **Feature Name Three** — Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.
- **Feature Name Four** — Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.
