...
Review content through lenses — each a distinct method and stance — and report findings in one canonical shape. Report what is real — never pad to look thorough. Each lens sets its own stance toward the content and toward zero findings: an empty result is valid throughout, and never filled by lowering the evidence bar; the adversarial lens makes one more pass for what is missing before it stops; the editorial lenses hold content sacrosanct and critique only how it is organized and expressed.
