...
var require_fs_native = __commonJS({
  "tools/installer/fs-native.js"(exports, module) {
...
var require_path_utils = __commonJS({
  "tools/installer/ide/shared/path-utils.js"(exports, module) {
    var AGENT_SEGMENT = "agents";
    var BMAD_FOLDER_NAME = "_bmad";
    function toDashName(module2, type, name) {
      const isAgent = type === AGENT_SEGMENT;
      if (module2 === "core") {
        return isAgent ? `bmad-agent-${name}.md` : `bmad-${name}.md`;
      }
      if (module2 === "standalone") {
        return isAgent ? `bmad-agent-standalone-${name}.md` : `bmad-standalone-${name}.md`;
      }
      const dashName = name.replace(/\//g, "-");
      return isAgent ? `bmad-agent-${module2}-${dashName}.md` : `bmad-${module2}-${dashName}.md`;
    }
    function toDashPath(relativePath) {
      ...
      return toDashName(module2, type, name);
    }
    ...
    function parseDashName(filename) {
      ...
      if (parts.length === 2) {
        return {
          ...
          module: "core",
          type: "workflows",
          // Default to workflows for non-agent core items
          name: parts[1]
        };
      }
      if (parts[1] === "standalone") {
        return {
          ...
          module: "standalone",
          type: "workflows",
          // Default to workflows for non-agent standalone items
          name: parts.slice(2).join("-")
        };
      }
      return {
        ...
        module: parts[1],
        type: "workflows",
        // Default to workflows for non-agent module items
        name: parts.slice(2).join("-")
      };
    }
...
var require_prompts = __commonJS({
  "src/core-skills/bmad-module/scripts/lib/vendor/shims/prompts.cjs"(exports, module) {
    "use strict";
    var out = (m) => process.stdout.write(`${m}
`);
    var err = (m) => process.stderr.write(`${m}
`);
    var log = {
      info: async (m) => out(m),
...
var require_platform_codes = __commonJS({
  "tools/installer/ide/platform-codes.js"(exports, module) {
    var fs = require_fs_native();
    var path = __require("node:path");
    var yaml = require_dist();
    var _cachedPlatformCodes = null;
    ...
    async function formatPlatformList() {
      const { IdeManager } = require_manager();
...
var require_sync = __commonJS({
  "node_modules/csv-parse/dist/cjs/sync.cjs"(exports) {
    "use strict";
...
var require_installed_skills = __commonJS({
  "tools/installer/ide/shared/installed-skills.js"(exports, module) {
    var path = __require("node:path");
    var fs = require_fs_native();
    var csv = require_sync();
...
var require_project_root = __commonJS({
  "src/core-skills/bmad-module/scripts/lib/vendor/shims/project-root.cjs"(exports, module) {
    "use strict";
    var path = __require("node:path");
...
var require_config_driven = __commonJS({
  "tools/installer/ide/_config-driven.js"(exports, module) {
    var path = __require("node:path");
    var fs = require_fs_native();
    var yaml = require_dist();
    var prompts = require_prompts();
    var csv = require_sync();
    var { BMAD_FOLDER_NAME } = require_path_utils();
    var { getInstalledCanonicalIds, isBmadOwnedEntry } = require_installed_skills();
    var RESERVED_OPENCODE_COMMANDS = /* @__PURE__ */ new Set([
      "review",
      "commit",
      "init",
      "help",
    ...
    var DEFAULT_COMMANDS_BODY_TEMPLATE = "@skills/{canonicalId}";
...
`;
    ...
    var ConfigDrivenIdeSetup = class {
  ...
  Please remove the BMAD files from that directory first:
    rm -rf "${conflict}"/bmad*`
      ...
      async installToTarget(projectDir, bmadDir, config, options) {
        ...
        this.skillWriteTracker = /* @__PURE__ */ new Set();
      ...
      async installVerbatimSkills(projectDir, bmadDir, targetPath, config) {
        ...
        for (const record of records) {
          ...
          const skipPatterns = /* @__PURE__ */ new Set([".DS_Store", "Thumbs.db", "desktop.ini"]);
      ...
      async cleanup(projectDir, options = {}, bmadDir = null) {
        ...
        if (this.installerConfig?.commands_target_dir) {
          ...
          const activeSkillIds = isInstallFlow ? await this._readActiveSkillIds(resolvedBmadDir) : /* @__PURE__ */ new Set();
      ...
      async loadRemovalLists(bmadDir) {
        ...
        const { getProjectRoot } = require_project_root();
       ...
       */
      async cleanupCommandPointers(projectDir, commandsTargetDir, options = {}, removalSet = /* @__PURE__ */ new Set(), activeSkillIds = /* @__PURE__ */ new Set(), extension = ".md") {
       ...
       */
      async cleanupTarget(projectDir, targetDir, options = {}, removalSet = /* @__PURE__ */ new Set()) {
...
var require_manager = __commonJS({
  "tools/installer/ide/manager.js"(exports, module) {
    var { BMAD_FOLDER_NAME } = require_path_utils();
    var prompts = require_prompts();
    var IdeManager = class {
      constructor() {
      ...
      async loadConfigDrivenHandlers() {
        const { loadPlatformCodes } = require_platform_codes();
        const platformConfig = await loadPlatformCodes();
        const { ConfigDrivenIdeSetup } = require_config_driven();
      ...
      async cleanupByList(projectDir, ideList, options = {}) {
        ...
        const remainingTargets = /* @__PURE__ */ new Set();
...
var require_ide_sync = __commonJS({
  "tools/installer/core/ide-sync.js"(exports, module) {
    var path = __require("node:path");
    var fs = require_fs_native();
    var { IdeManager } = require_manager();
    var { BMAD_FOLDER_NAME } = require_path_utils();
    var writeOut = (m) => process.stdout.write(`${m}
`);
    var writeErr = (m) => process.stderr.write(`${m}
`);
    var DEFAULT_LOGGER = { info: writeOut, warn: writeErr, error: writeErr };
    ...
    async function runIdeSyncCli2(argv = []) {
    ...
    module.exports = {
      ...
      readSelectedIdes,
      runIdeSync,
      runIdeSyncCli: runIdeSyncCli2
    };
  }
});

// tools/installer/ide-sync-entry.mjs
var import_ide_sync = __toESM(require_ide_sync(), 1);
...
(0, import_ide_sync.runIdeSyncCli)(process.argv.slice(2)).then((code) => process.exit(code)).catch((err) => {
