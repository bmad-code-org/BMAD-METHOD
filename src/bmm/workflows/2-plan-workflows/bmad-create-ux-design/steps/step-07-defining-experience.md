...
- Load `./steps/step-08-visual-foundation.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-08-visual-foundation.md` to establish visual design foundation.
