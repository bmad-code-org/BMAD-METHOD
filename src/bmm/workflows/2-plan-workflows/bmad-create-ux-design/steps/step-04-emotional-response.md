...
- Load `./steps/step-05-inspiration.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-05-inspiration.md` to analyze UX patterns from inspiring products.
