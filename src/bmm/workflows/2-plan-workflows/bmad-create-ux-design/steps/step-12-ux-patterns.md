...
- Load `./steps/step-13-responsive-accessibility.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.
