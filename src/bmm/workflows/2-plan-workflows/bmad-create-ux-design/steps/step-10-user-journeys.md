...
- Load `./steps/step-11-component-strategy.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-11-component-strategy.md` to define component library strategy.
