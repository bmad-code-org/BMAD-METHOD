...
- Load `./steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-07-defining-experience.md` to define the core user interaction.
