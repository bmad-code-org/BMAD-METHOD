...
- Load `./steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-04-emotional-response.md` to define desired emotional responses.
