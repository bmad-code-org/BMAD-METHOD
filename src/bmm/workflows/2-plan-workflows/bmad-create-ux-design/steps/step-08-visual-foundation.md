...
- Load `./steps/step-09-design-directions.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-09-design-directions.md` to generate design direction mockups.
