...
- Load `./steps/step-12-ux-patterns.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-12-ux-patterns.md` to define UX consistency patterns.
