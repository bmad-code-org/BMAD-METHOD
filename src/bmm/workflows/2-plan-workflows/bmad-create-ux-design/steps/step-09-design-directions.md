...
- Load `./steps/step-10-user-journeys.md`
...
After user selects 'C' and content is saved to document, load `./steps/step-10-user-journeys.md` to design user journey flows.
