...
<critical>The workflow execution engine is governed by: {bmad_folder}/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {bmad_folder}/bmm/workflows/3-solutioning/solutioning-gate-check/workflow.yaml</critical>
