...
4. **Running and verifying** — the canonical entry points and toolchain pins, plus what `package.json`, `pyproject.toml`, a `Makefile`, or CI config does not already say.
