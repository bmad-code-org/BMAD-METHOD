...
- Only modify the story file in these areas: Tasks/Subtasks checkboxes, Dev Agent Record (Debug Log, Completion Notes, Marking Review Follow-ups), File List, Change Log, and Status
